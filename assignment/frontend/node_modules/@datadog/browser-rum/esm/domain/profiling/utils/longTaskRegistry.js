 ...
 */
export function setLongTaskId(longTaskId, performanceEntryStartTime) {
    registry.set(performanceEntryStartTime, longTaskId);
}
export function getLongTaskId(longTaskEntry) {
...
export function deleteLongTaskIdsBefore(collectionTime) {
