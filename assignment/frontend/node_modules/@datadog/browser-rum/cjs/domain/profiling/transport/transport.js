...
const sendProfile = (profilerTrace, endpointBuilder, applicationId, sessionId) => {
    ...
    (0, browser_core_1.addTelemetryDebug)('Sending profile to public profiling intake', { profilingIntakeURL, applicationId, sessionId });
...
function buildProfileEventAttributes(profilerTrace, applicationId, sessionId) {
    ...
    const longTaskIds = profilerTrace.longTasks
        .map((longTask) => (0, longTaskRegistry_1.getLongTaskId)(longTask))
