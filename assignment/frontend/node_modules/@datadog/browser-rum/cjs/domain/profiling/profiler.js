...
function createRumProfiler(configuration, lifeCycle, session, profilerConfiguration = exports.DEFAULT_RUM_PROFILER_CONFIGURATION) {
    ...
    async function stop() {
        ...
        (0, longTaskRegistry_1.disableLongTaskRegistry)();
    ...
    function addEventListeners(existingInstance) {
        ...
        if (configuration.trackLongTasks) {
            ...
            (0, longTaskRegistry_1.enableLongTaskRegistry)();
    ...
    async function collectProfilerInstance(lastInstance) {
        ...
        await lastInstance.profiler
            ...
            (0, longTaskRegistry_1.deleteLongTaskIdsBefore)(collectTime);
        })
    ...
    function handleLongTaskEntries(entries) {
        ...
        for (const entry of entries) {
            ...
            instance.longTasks.push({
                id: (0, longTaskRegistry_1.getLongTaskId)(entry),
