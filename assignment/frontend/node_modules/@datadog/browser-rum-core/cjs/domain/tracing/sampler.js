...
exports.resetSampleDecisionCache = resetSampleDecisionCache;
exports.sampleUsingKnuthFactor = sampleUsingKnuthFactor;
...
function isTraceSampled(sessionId, sampleRate) {
    ...
    if (window.BigInt) {
        ...
        decision = (0, browser_core_1.performDraw)(sampleRate);
    }
