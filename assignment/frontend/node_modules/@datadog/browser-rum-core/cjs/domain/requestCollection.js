...
function startRequestCollection(lifeCycle, configuration, sessionManager, getCommonContext) {
    const tracer = (0, tracer_1.startTracer)(configuration, sessionManager, getCommonContext);
