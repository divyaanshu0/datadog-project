...
function createPreStartStrategy({ ignoreInitIfSyntheticsWillInjectRum, startDeflateWorker }, trackingConsentState, customVitalsState, doStartRum) {
    ...
    const globalContext = (0, globalContext_1.buildGlobalContextManager)();
    bufferContextCalls(globalContext, browser_core_1.CustomerContextKey.globalContext, bufferApiCalls);
    const userContext = (0, userContext_1.buildUserContextManager)();
    bufferContextCalls(userContext, browser_core_1.CustomerContextKey.userContext, bufferApiCalls);
    const accountContext = (0, accountContext_1.buildAccountContextManager)();
