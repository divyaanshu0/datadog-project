import type { Context, User, Account, DeflateWorker, DeflateEncoderStreamId, DeflateEncoder, TrackingConsent, PublicApi, ContextManager } from '@datadog/browser-core';
